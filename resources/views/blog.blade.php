                            ...
                            <div class="small-product-list recent-post">
                                <div class="single-product-item">
                                    <figure class="product-thumb">
                                        <a href="#"><img class="img-fluid" src="/front/img/product-2.jpg"
                                                         alt="Products"/></a>
                                    </figure>
                                    <div class="product-details">
                                        <h2><a href="{{ route('blog.show') }}">Lorem ipsum is dolor sit amet, consectetur
                                ...
                                <div class="single-product-item">
                                    <figure class="product-thumb">
                                        <a href="#"><img class="img-fluid" src="/front/img/product-3.jpg"
                                                         alt="Products"/></a>
                                    </figure>
                                    <div class="product-details">
                                ...
                                <div class="single-product-item">
                                    <figure class="product-thumb">
                                        <a href="#"><img class="img-fluid" src="/front/img/product-4.jpg"
                                                         alt="Products"/></a>
                                    </figure>
                                    <div class="product-details">
                                        <h2><a href="{{ route('blog.show') }}">Lorem ipsum is dolor sit amet, consectetur
                ...
                <div class="blog-content-wrap">
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="{{ route('blog.show') }}"><img src="/front/img/blog-thumb.jpg" alt="blog"
                                                            class="img-fluid"/></a>
                            <figcaption class="blog-icon">
                                <a href="{{ route('blog.show') }}"><i class="fa fa-file-image-o"></i></a>
                            </figcaption>
                        </figure>

                        <div class="blog-details">
                            <h3><a href="{{ route('blog.show') }}">Mirum est notare quam</a></h3>
                            ...
                            <a href="{{ route('blog.show') }}" class="btn-long-arrow">Read More</a>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="{{ route('blog.show') }}"><img src="/front/img/blog-thumb-2.jpg" alt="blog"
                                                            class="img-fluid"/></a>
                            <figcaption class="blog-icon">
                                <a href="{{ route('blog.show') }}"><i class="fa fa-file-image-o"></i></a>
                            </figcaption>
                    ...
                    <div class="single-blog-wrap">
                        <figure class="blog-thumb">
                            <a href="{{ route('blog.show') }}"><img src="/front/img/blog-thumb-3.jpg" alt="blog"
                                                            class="img-fluid"/></a>
                            <figcaption class="blog-icon">
                                <a href="{{ route('blog.show') }}"><i class="fa fa-file-image-o"></i></a>
                            </figcaption>
