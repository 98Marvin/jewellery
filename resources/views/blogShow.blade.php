                    ...
                    <article class="single-blog-content-wrap">
                        <div class="post-header">
                            <figure class="post-thumbnail">
                                <img src="/front/img/single-blog.jpg" class="img-fluid" alt="Blog" />
                            </figure>
                        ...
                        <div class="post-content">
                            ...
                            <img src="/front/img/home_4_slide_2.jpg" class="img-fluid" alt="Blog" />
                        ...
                        <div class="comments-preview-area comment-single-item">
                            ...
                            <div class="single-comment d-block d-md-flex">
                                <div class="comment-author">
                                    <a href="#"><img src="/front/img/author-1.jpg" class="img-fluid"
                                            alt="Comment User" /></a>
                                </div>
                            ...
                            <div class="single-comment reply d-block d-md-flex">
                                <div class="comment-author">
                                    <a href="#"><img src="/front/img/author-2.jpg" class="img-fluid"
                                            alt="Comment User" /></a>
                                </div>
                                <div class="comment-info mt-3 mt-md-0">
                                    <div class="comment-info-top d-flex justify-content-between">
                            ...
                            <div class="single-comment d-block d-md-flex">
                                <div class="comment-author">
                                    <a href="#"><img src="/front/img/author-3.jpg" class="img-fluid"
                                            alt="Comment User" /></a>
                                </div>
                                <div class="comment-info mt-3 mt-md-0">
                                    <div class="comment-info-top d-flex justify-content-between">
