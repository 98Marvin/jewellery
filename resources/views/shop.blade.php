                                ...
                                <div class="small-product-list">
                                    <div class="single-product-item">
                                        <figure class="product-thumb">
                                            <a href="#"><img class="mr-2 img-fluid" src="/front/img/product-2.jpg"
                                                    alt="Products" /></a>
                                        </figure>
                                    ...
                                    <div class="single-product-item">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img class="mr-2 img-fluid"
                                                    src="/front/img/product-3.jpg" alt="Products" /></a>
                                        </figure>
                                        <div class="product-details">
                            ...
                            <div class="sidebar-body">
                                <div class="small-product-list">
                                    <div class="single-product-item">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img class="mr-2 img-fluid"
                                                    src="/front/img/product-1.jpg" alt="Products" /></a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="single-product-item">
                                        <figure class="product-thumb">
                                            <a href="single-product.html"><img class="mr-2 img-fluid"
                                                    src="/front/img/product-2.jpg" alt="Products" /></a>
                                        </figure>
                                        <div class="product-details">
                                            <h2><a href="single-product.html">Sprite Yoga Companion Kit</a></h2>
                                            <span class="price">$6.00</span>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/new-product-1.jpg"
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/new-product-2.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/new-product-3.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/new-product-4.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/product-4.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product-item text-center">
                                            <figure class="product-thumb">
                                                <a href="single-product.html"><img src="/front/img/product-3.jpg"
                                                        alt="Products" class="img-fluid"></a>
                                            </figure>
