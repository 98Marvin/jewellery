                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 text-center">
                                <div class="contact-method-item">
                                    ...
                                    <div class="method-info">
                                        ...
                                        <p>Address : South B <br> Nairobi, Kenya.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Method End -->
                            ...
                            <div class="col-lg-3 col-sm-6 text-center">
                                <div class="contact-method-item">
                                    ...
                                    <div class="method-info">
                                        <h3>Phone Number</h3>
                                        <a href="tel:0(1234)56789012">0748851889</a>
                                        <a href="tel:0(1234)56789012">0792859370</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Method End -->
                            ...
                            <div class="col-lg-3 col-sm-6 text-center">
                                <div class="contact-method-item">
                                    ...
                                    <div class="method-info">
                                        <h3>Number Fax</h3>
                                        <p>+254 323 555 1234 <br> +254 267 555 12342</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Method End -->
                            ...
                            <div class="col-lg-3 col-sm-6 text-center">
                                <div class="contact-method-item">
                                    ...
                                    <div class="method-info">
                                        <h3>Email Address</h3>
                                        <a href="mailto:info@diamond.co.ke">info@diamond.co.ke</a>
                                        <a href="mailto:admin@diamond.co.ke">admin@diamond.co.ke</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Method End -->
